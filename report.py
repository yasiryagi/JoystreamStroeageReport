...
def get_draw_objects(file1name, file2name):
  ...
  ax.set_xticks(np.arange(0, len(dates)+1, 200))
  ax.set_yticks(np.arange(0, max(sizes), 10))
  ...
  ax.set_xticks(np.arange(0, len(dates)+1, 1000))
  ax.set_yticks(np.arange(0, max(num_objects), 10))
  plt.xticks(rotation=45)
  plt.yticks(rotation=45)
